...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   subroutine readDics(fileName, dicsBasis)
       ...
       character*26, intent(in)::fileName  
       logical::exists
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine read_totalcs(self,tcstype,filename)
    ...
    integer:: nch, nchi
    character*20:: stren, str1, str2, str3, str4
...
!
  ...
  subroutine write_tcs(tcs)
      ...
      type(totalcs)::tcs
      integer:: ii
      character*20::filename, enString
  ...
  subroutine set_cs_tcs(tcs,Nmax,enin,csin)
    implicit none
    type(totalcs), intent(inout):: tcs
    integer, intent(in):: Nmax
    real(dp), dimension(Nmax):: enin, csin
...
!  
  ...
  subroutine getTics(tcsIn, tics)
    ...
    subroutine fitTotalCs(tcs,enInArray,enLen)
        ...
        type(totalcs), intent(inout)::tcs
        real(dp)::a,b, yBar, xBar, numerator, denom, currEn
        ...
        real(dp), allocatable, dimension(:,:)::xMat, invMat
        integer, allocatable, dimension(:,:)::pivot
        real(dp), dimension(2)::betaVec
  ...
  subroutine readTcsBenchmark(tcsbasis,statebasis,Nenfine, enfine, TICS)
      ...
      real(dp):: enex, spin, stateEn
      integer:: l, m, ipar, remainder, numPatches
      character(len=10):: stlabel
      character*10:: ionString
