...
contains
  ...
  subroutine make_elastic_dcs(self,Nenfine,enfine)
    ...
    character(len=20)::  str1,str2,str3,str4,str5
    real(dp):: ein,  ONEpi, TWOpi, th, cs, avtheta, ang, thang
    real(dp), dimension(Nang):: tmptheta, dcs, y
    integer:: i, n, im, itm, ien, halfInt
...
!!$  close(20)
  ...
  subroutine make_inelastic_dcs(dcsBasis,stateBasis)
      ...
      integer::  jj, kk, space
      integer:: ioStatVar, l,  numFilesCor, ll
      integer:: ind1, ind2
      real(dp):: w1, w2
      logical:: found
      real(dp):: currEn, elasticVal, currEnPrev
      real(dp), dimension(:), allocatable::thetaArray, dcsCorrArray, thetaArray1, intpDCS
      real(dp), dimension(:,:), allocatable::dcsArray
      character(len=30)::str1, str2, str3, str4,  str6, str7, str8, str9
  ...
  subroutine getNumStatesDcs(filename,numStates,space)
      ...
      character(len=6)::lineString, thetaString, unitString, angleString
      integer:: unitCounter
...
20     continue
    ...
    subroutine placeDcs(dcsIn, inLen, dcsBasis) 
        ...
        type(basis_dcs)::dcsBasis
        real(dp)::  tolerance
        integer::  inLen, basisSize, numCommon
        integer::ii, jj, kk
